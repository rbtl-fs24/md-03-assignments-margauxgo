...
4.  How many observations are in the data set? 344 x 8 = 2'752
5.  What data types are contained in the variables? (Reminder: [https://rbtl-fs24.github.io/website/slides/lec-02-visualisation.html#/types-of-variables](https://ds4owd-001.github.io/website/slides/lec-02-visualisation.html#/types-of-variables){.uri}) factors, doubles and integers
...
penguins %>%
  ...
  summarise(bill_depth_mean = mean(bill_depth_mm),
            bill_length_mean = mean(bill_length_mm), count = n())
```
